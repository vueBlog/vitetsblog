...
import { pageAsideModel, articleItemModel, columnDetailModel, columnDetailReqModel } from './../types'
...
const aside = reactive<pageAsideModel>({
  loading: true,
  list: []
})
...
const columnInfo = reactive<columnDetailModel>({
  columnContent: '',
  columnId: 0,
  columnNumber: 0,
  columnTitle: '',
